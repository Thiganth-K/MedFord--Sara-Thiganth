...
// Visual effects components for the demo
...
export default function ImageLens({ imageSrc, title, description }) {
  ...
  return (
    <div className="w-full relative rounded-3xl overflow-hidden max-w-md mx-auto bg-gradient-to-r from-[#1D2235] to-[#121318] p-8 my-10">
      ...
      <div className="relative z-10">
        <Lens hovering={hovering} setHovering={setHovering} zoomFactor={1.8}>
          <img
            src={imageSrc}
            alt={title}
            width={500}
