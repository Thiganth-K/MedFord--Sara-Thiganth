  ...
  return (
    ...
    >
      <div className="relative max-w-5xl mx-auto">
        <nav className="flex justify-between items-center bg-white/70 backdrop-blur-xl rounded-full shadow-lg border border-white/20 px-6 py-3">
          <Link to="/" className="flex items-center gap-3 text-lg font-bold text-gray-800 hover:text-primary transition-colors">
            <Logo />
